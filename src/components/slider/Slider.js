...
import { MdKeyboardArrowLeft as Left, MdKeyboardArrowRight as Right } from "react-icons/md";
...
const Slider = () => {
  ...
  function prevSlide() {
    setImageIndex(imageIndex > images.length - 1 ? images.length - 1 : imageIndex <= 0 ? images.length - 1 : imageIndex - 1);
  }
  ...
  return (
    <div className="slider">
      <div className="slider__container">
        ...
        <div className={black ? "slider__nav-button" : "slider__nav-button white"}>
          <Left style={{ fontSize: "2rem" }} onClick={prevSlide} />
          <Right style={{ fontSize: "2rem" }} onClick={nextSlide} />
        </div>
        <div className={black ? "slider__nav-controls" : "slider__nav-controls white"}>
          <div className="slider__nav-controls slider__nav-controls-container">
            <div onClick={()=> setImageIndex(0)} className={imageIndex === 0 ? "slider__nav-controls-container-circle active active--black" : "slider__nav-controls-container-circle"}></div>
            <div onClick={()=> setImageIndex(1)} className={imageIndex === 1 ? "slider__nav-controls-container-circle active" : "slider__nav-controls-container-circle"}></div>
            <div onClick={()=> setImageIndex(2)} className={imageIndex === 2 ? "slider__nav-controls-container-circle active active--black" : "slider__nav-controls-container-circle"}></div>
            <div onClick={()=> setImageIndex(3)} className={imageIndex === 3 ? "slider__nav-controls-container-circle active" : "slider__nav-controls-container-circle"}></div>
          </div>
          <div className="slider__nav-controls-line"></div>
          <div style={{display: "flex", justifyContent:"space-around", marginTop: "1vh"}}>
            <div className={imageIndex === 0 ? "slider__nav-controls-line-circle slider__nav-controls-line-circle--active" : "slider__nav-controls-line-circle"}></div> 
            <div className={imageIndex === 1 ? "slider__nav-controls-line-circle slider__nav-controls-line-circle--active" : "slider__nav-controls-line-circle"}></div>
            <div className={imageIndex === 2 ? "slider__nav-controls-line-circle slider__nav-controls-line-circle--active" : "slider__nav-controls-line-circle"}></div>
            <div className={imageIndex === 3 ? "slider__nav-controls-line-circle slider__nav-controls-line-circle--active" : "slider__nav-controls-line-circle"}></div>
          </div>
